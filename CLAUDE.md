...
| **WSL** as a way to run anything                                            | operator directive 2026-09-12: a Windows binary that only runs under a Linux kernel is not a Windows binary — fix the Windows build, see below                                                                                                                     |
