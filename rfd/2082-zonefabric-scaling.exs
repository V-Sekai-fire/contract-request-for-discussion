...
defmodule RFD2082 do
  ...
  rfd 2082, "Zonefabric scaling" do
    ...
    **Scale knob:** zone count (direct, no multiplier) **Source:**
    ...
    details_title "Zonefabric scaling"
    ...
    **Cost**: 1 range read (~10 entities near boundary).
    ...
    details "Benchmark methodology", ~S"""
    ...
    details "What zonefabric measures that existing benchmarks don't", ~S"""
    ...
    details "Bridge to mas-bandwidth/fps", ~S"""
    ...
    details "Architectural completeness", ~S"""
